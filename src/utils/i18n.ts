...
const translations: Record<Language, Translations> = {
  ru: {
    common: {
      ...
      signature: 'Анастасия, ваш wellness-консультант',
      brandFirstName: 'Анастасия',
      brandLastName: 'Дударева',
      next: 'Далее',
      back: 'Назад',
      submit: 'Отправить',
      submitting: 'Отправка...',
  ...
  en: {
    common: {
      ...
      signature: 'Anastasia, your wellness consultant',
      brandFirstName: 'Anastasia',
      brandLastName: 'Dudareva',
      next: 'Next',
      back: 'Back',
      submit: 'Submit',
